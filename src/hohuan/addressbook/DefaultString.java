...
public class DefaultString {
  ...
  public static final String MESSAGE_INVALID_PROGRAM_ARGS = "Too many parameters! Correct program argument format:"
      + DefaultString.LS + "\tjava AddressBook" + DefaultString.LS + "\tjava AddressBook [custom storage file path]";
  ...
  public static final String COMMAND_ADD_PARAMETERS = "NAME " + DefaultString.PERSON_DATA_PREFIX_PHONE + "PHONE_NUMBER "
      + DefaultString.PERSON_DATA_PREFIX_EMAIL + "EMAIL";
